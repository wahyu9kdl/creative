...
echo "$merah /  Author  : ALHIKMAH.MY.ID                        /\n";
echo "$magenta / Website : https://www.alhikmah.my.id /\n";
echo "$hijau / FansPage : https://www.facebook.com/Awgroupchannel                  /\n";
echo "$kuning / Github :   https://github.com/wahyu9kdl                     /\n";
echo "$cyan ###################################################\n";
